...
from app.services.telegram_auth import (
    ...
    _ensure_social_account_async,
    _maybe_update_consultant_nickname,
    _maybe_update_consultant_nickname_async,
)
...
async def find_or_create_user_from_webapp_async(db, tg_user: dict) -> User | None:
